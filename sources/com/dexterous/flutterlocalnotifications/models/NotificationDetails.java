...
public class NotificationDetails implements Serializable {
    ...
    @b(alternate = {"allowWhileIdle"}, value = "scheduleMode")
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                Map next = it.next();
                arrayList2.add(new MessageDetails((String) next.get(TEXT), C0094a.I(next.get(TIMESTAMP)), readPersonDetails((Map) next.get(PERSON)), (String) next.get(DATA_MIME_TYPE), (String) next.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
    ...
    private static void readPlatformSpecifics(Map<String, Object> map, NotificationDetails notificationDetails) {
        ...
        if (map2 != null) {
            ...
            notificationDetails.when = C0094a.I(map2.get(WHEN));
            ...
            notificationDetails.timeoutAfter = C0094a.I(map2.get(TIMEOUT_AFTER));
