...
public final class o extends C0527a implements Serializable {

    /* renamed from: o  reason: collision with root package name */
    public static final o f5020o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d  reason: collision with root package name */
    private final transient String f5021d = "Hijrah-umalqura";

    /* renamed from: e  reason: collision with root package name */
    private final transient String f5022e = "islamic-umalqura";

    /* renamed from: f  reason: collision with root package name */
    private volatile transient boolean f5023f;

    /* renamed from: g  reason: collision with root package name */
    private transient int[] f5024g;

    /* renamed from: h  reason: collision with root package name */
    private transient int f5025h;

    /* renamed from: i  reason: collision with root package name */
    private transient int f5026i;

    /* renamed from: j  reason: collision with root package name */
    private transient int f5027j;

    /* renamed from: k  reason: collision with root package name */
    private transient int f5028k;

    /* renamed from: l  reason: collision with root package name */
    private transient int f5029l;

    /* renamed from: m  reason: collision with root package name */
    private transient int f5030m;

    /* renamed from: n  reason: collision with root package name */
    private transient int f5031n;

    static {
        o oVar = new o();
        f5020o = oVar;
        C0527a.C(oVar, "Hijrah");
        C0527a.C(oVar, "islamic");
    }
    ...
    private void Z() {
        if (!this.f5023f) {
            ...
            try {
                ...
                int[][] h02 = h0();
                int v = (int) h.g0(1882, 11, 12).v();
                int i3 = 1300;
                while (i3 <= 1600) {
                    int[] iArr = h02[i3 - 1300];
                    if (iArr.length == 12) {
                ...
                } else if (!this.f5022e.equals("islamic-umalqura")) {
                    throw new IllegalArgumentException("Configuration is for a different calendar type: islamic-umalqura");
                } else if (v != 0) {
                    this.f5027j = 15600;
                    this.f5025h = v;
                    int[] b02 = b0(v, hashMap);
                    this.f5024g = b02;
                    this.f5026i = b02[3612];
                    for (int i4 = 1300; i4 < 1600; i4++) {
                        int i5 = (i4 * 12) - this.f5027j;
                        int[] iArr2 = this.f5024g;
                        int i6 = iArr2[i5 + 12] - iArr2[i5];
                        this.f5030m = Math.min(this.f5030m, i6);
                        this.f5031n = Math.max(this.f5031n, i6);
                    }
                    this.f5023f = true;
                } else {
                ...
                throw new RuntimeException("Unable to initialize HijrahCalendar: " + str, e2);
            }
        }
    }
    ...
    public final C0528b G(int i3, int i4, int i5) {
        return q.Z(this, i3, i4, i5);
    }

    public final C0528b A(int i3, int i4) {
        q Z = q.Z(this, i3, 1, 1);
        if (i4 <= Z.W()) {
            return Z.C((long) (i4 - 1));
        }
        throw new RuntimeException("Invalid dayOfYear: " + i4);
    }
    ...
    public final C0528b L() {
        return q.a0(this, h.f0(b.b()).g(a.EPOCH_DAY));
    }
    ...
    public final C0528b t(TemporalAccessor temporalAccessor) {
        ...
        return q.a0(this, temporalAccessor.g(a.EPOCH_DAY));
    }
    ...
    public final w U(a aVar) {
        ...
        switch (n.f5019a[aVar.ordinal()]) {
            case 1:
                return w.k((long) this.f5028k, (long) this.f5029l);
            case k.FLOAT_FIELD_NUMBER:
                return w.j(1, (long) this.f5031n);
            case k.INTEGER_FIELD_NUMBER:
                return w.j(1, 5);
            case k.LONG_FIELD_NUMBER:
            case k.STRING_FIELD_NUMBER:
                int i3 = this.f5027j;
                return w.j((long) (i3 / 12), (long) ((((this.f5024g.length - 1) + i3) / 12) - 1));
    ...
    public final C0528b P(Map map, y yVar) {
        return (q) super.P(map, yVar);
    }

    /* access modifiers changed from: package-private */
    public final int[] e0(int i3) {
        Z();
        if (i3 < this.f5025h || i3 >= this.f5026i) {
            throw new RuntimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f5024g, i3);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i4 = this.f5027j;
        return new int[]{(binarySearch + i4) / 12, ((i4 + binarySearch) % 12) + 1, (i3 - this.f5024g[binarySearch]) + 1};
    }
    ...
    public final long d0(int i3, int i4, int i5) {
        Z();
        if (i4 < 1 || i4 > 12) {
            throw new RuntimeException("Invalid Hijrah month: " + i4);
        }
        int i6 = (i4 - 1) + ((i3 * 12) - this.f5027j);
        if (i6 < 0 || i6 >= this.f5024g.length) {
            throw new RuntimeException("Invalid Hijrah date, year: " + i3 + ", month: " + i4);
        } else if (i5 < 1 || i5 > f0(i3, i4)) {
            throw new RuntimeException("Invalid Hijrah day of month: " + i5);
        } else {
            return (long) ((i5 - 1) + this.f5024g[i6]);
        }
    }
    ...
    public final int a0(long j3) {
        int i3 = this.f5027j;
        if (j3 >= ((long) (i3 / 12)) && j3 <= ((long) ((((this.f5024g.length - 1) + i3) / 12) - 1))) {
            return (int) j3;
        }
        throw new RuntimeException("Invalid Hijrah year: " + j3);
    }

    /* access modifiers changed from: package-private */
    public final int c0(int i3, int i4) {
        int i5 = (i3 * 12) - this.f5027j;
        int[] iArr = this.f5024g;
        return iArr[(i4 - 1) + i5] - iArr[i5];
    }

    /* access modifiers changed from: package-private */
    public final int f0(int i3, int i4) {
        int i5 = (i4 - 1) + ((i3 * 12) - this.f5027j);
        if (i5 >= 0) {
            int[] iArr = this.f5024g;
            if (i5 < iArr.length) {
                return iArr[i5 + 1] - iArr[i5];
            }
        }
        throw new RuntimeException("Invalid Hijrah date, year: " + i3 + ", month: " + i4);
    }
    ...
    public final int g0(int i3) {
        int i4 = (i3 * 12) - this.f5027j;
        int[] iArr = this.f5024g;
        return iArr[i4 + 12] - iArr[i4];
    }
    ...
    private int[] b0(int i3, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.f5028k = Integer.MAX_VALUE;
        ...
        for (int i5 = 1300; i5 <= 1600; i5++) {
            ...
            while (i6 < 12) {
                ...
                i3 += i7;
                this.f5028k = Math.min(this.f5028k, i7);
                this.f5029l = Math.max(this.f5029l, i7);
                i6++;
                i4 = i8;
            }
        }
        ...
        throw new IllegalStateException("Did not fill epochMonths exactly: ndx = " + i9 + " should be " + 3613);
    }
