...
public final class h {
    ...
    public h(Context context, String str) {
        this.f3850a = context.getSharedPreferences("FirebaseHeartBeat" + str, 0);
    }

    public final synchronized void a() {
        try {
            long j3 = this.f3850a.getLong("fire-count", 0);
            String str = "";
            String str2 = null;
            for (Map.Entry next : this.f3850a.getAll().entrySet()) {
            ...
            HashSet hashSet = new HashSet(this.f3850a.getStringSet(str, new HashSet()));
            hashSet.remove(str2);
            this.f3850a.edit().putStringSet(str, hashSet).putLong("fire-count", j3 - 1).commit();
        } finally {
            while (true) {
            }
        }
        ...
        try {
            ...
            for (Map.Entry next : this.f3850a.getAll().entrySet()) {
                if (next.getValue() instanceof Set) {
                    ...
                    if (((Set) next.getValue()).contains(d3)) {
            ...
            if (i3 == 0) {
                ...
                edit.putLong("fire-count", (long) i3);
            }
            edit.commit();
        } finally {
            while (true) {
    ...
    public final synchronized java.util.ArrayList c() {
        /*
            ...
            android.content.SharedPreferences r1 = r6.f3850a     // Catch:{ all -> 0x0058 }
        ...
        L_0x0014:
            ...
            j1.a r3 = new j1.a     // Catch:{ all -> 0x0058 }
        ...
        L_0x005a:
            ...
            android.content.SharedPreferences r3 = r6.f3850a     // Catch:{ all -> 0x0071 }
        ...
        L_0x0074:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: j1.h.c():java.util.ArrayList");
    }
    ...
    public final synchronized void f(java.lang.String r5) {
        ...
        L_0x0009:
            ...
            android.content.SharedPreferences r2 = r4.f3850a     // Catch:{ all -> 0x0030 }
            ...
            android.content.SharedPreferences r5 = r4.f3850a     // Catch:{ all -> 0x0030 }
        ...
        L_0x0041:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: j1.h.f(java.lang.String):void");
    }
    ...
    public final synchronized boolean g(long r6) {
        /*
            ...
            monitor-enter(r5)
            android.content.SharedPreferences r1 = r5.f3850a     // Catch:{ all -> 0x0033 }
        ...
        L_0x004a:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: j1.h.g(long):boolean");
    }

    public final synchronized void h(long j3, String str) {
        String d3 = d(j3);
        if (this.f3850a.getString("last-used-date", "").equals(d3)) {
            String e2 = e(d3);
            if (e2 != null) {
                if (!e2.equals(str)) {
                    i(str, d3);
        ...
        long j4 = this.f3850a.getLong("fire-count", 0);
        if (j4 + 1 == 30) {
            a();
            j4 = this.f3850a.getLong("fire-count", 0);
        }
        HashSet hashSet = new HashSet(this.f3850a.getStringSet(str, new HashSet()));
        hashSet.add(d3);
        this.f3850a.edit().putStringSet(str, hashSet).putLong("fire-count", j4 + 1).putString("last-used-date", d3).commit();
    }
    ...
    public final synchronized void i(String str, String str2) {
        ...
        HashSet hashSet = new HashSet(this.f3850a.getStringSet(str, new HashSet()));
        hashSet.add(str2);
        this.f3850a.edit().putStringSet(str, hashSet).commit();
    }
}
