  ...
  return (
    <main className="godot-web-shell" aria-label="Lucky5 Godot cabinet">
      <section className="godot-web-missing" aria-live="polite">
        ...
        <p>Generate the shared cabinet export before launching this route.</p>
...
export function GodotWebShell({ fallback }: GodotWebShellProps) {
